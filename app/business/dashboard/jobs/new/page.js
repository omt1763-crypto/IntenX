...
export default function NewJobPage() {
  ...
  const copyLink = async () => {
    ...
    try {
      ...
      console.warn('[BusinessNewJob] Copy to clipboard failed:', e.message || e)
    }
  }
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="ml-64">
          {/* Header */}
          <motion.div
            className="sticky top-0 z-40 border-b border-[#11cd68]/50 bg-gradient-to-r from-[#007a78] to-[#00a89a] backdrop-blur-md"
            ...
            <div className="px-8 py-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#d1f2eb] mt-1">Your interview link is ready to share</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="px-8 py-12 relative z-10">
            ...
            >
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-8 shadow-lg mb-8">
                ...
                <div className="grid grid-cols-2 gap-4 pb-6 border-b border-slate-200 mb-6">
                  {createdJob.location && (
                    <div className="flex items-center gap-2 text-slate-700">
                      <LinkIcon className="w-4 h-4 text-[#007a78]" />
                ...
                <div className="bg-gradient-to-br from-[#f0fdf4] to-[#f0fdf4]/50 border border-[#11cd68]/30 rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      <LinkIcon className="w-5 h-5 text-[#007a78]" />
                      ...
                      <button
                        ...
                        className={`px-4 py-3 rounded-lg font-semibold transition-all flex items-center gap-2 ${
                          copied
                            ...
                            : 'bg-[#007a78] text-white hover:bg-[#00a89a] hover:shadow-lg'
                        }`}
                      >
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 px-6 py-3 border border-[#007a78] text-[#007a78] rounded-lg hover:bg-[#f0fdf4] transition-colors font-semibold"
                >
                  View All Jobs
                </button>
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-[#007a78] to-[#00a89a] text-white rounded-lg hover:shadow-lg hover:shadow-teal-400/30 transition-all font-semibold"
                >
                  Create Another Job
                </button>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#d1f2eb] mt-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:border-[#007a78] focus:ring-2 focus:ring-[#007a78]/20 bg-white transition-colors"
                  required
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="6"
                  className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:border-[#007a78] focus:ring-2 focus:ring-[#007a78]/20 bg-white transition-colors resize-none"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  <input
                    ...
                    className="flex-1 px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:border-[#007a78] focus:ring-2 focus:ring-[#007a78]/20 bg-white transition-colors"
                  />
                  <button
                    type="button"
                    onClick={handleAddSkill}
                    className="px-4 py-3 bg-gradient-to-r from-[#007a78] to-[#00a89a] text-white rounded-lg hover:shadow-lg hover:shadow-teal-400/30 transition-all font-semibold flex items-center gap-2"
                  >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {formData.requiredSkills.map((skill) => (
                      <motion.div
                        ...
                        className="flex items-center gap-2 px-3 py-2 bg-[#f0fdf4] border border-[#11cd68]/30 rounded-full"
                      >
                        <span className="text-sm font-medium text-[#007a78]">
                          {skill}
                        </span>
                        <button
                          type="button"
                          onClick={() => handleRemoveSkill(skill)}
                          className="text-[#007a78] hover:text-red-600 transition-colors"
                        >
                          <X className="w-4 h-4" />
                        </button>
                      </motion.div>
              ...
              <div className="flex gap-4 pt-6">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-[#007a78] to-[#00a89a] text-white rounded-lg hover:shadow-lg hover:shadow-teal-400/30 transition-all font-semibold disabled:opacity-50"
                >
