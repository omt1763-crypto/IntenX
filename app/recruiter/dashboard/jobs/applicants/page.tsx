          ...
          <div className="px-8 py-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-blue-50 mt-1">Position: {jobTitle}</p>
              </div>
            </div>
          </div>
        </motion.div>
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right space-y-3">
                      ...
                      <button
                        onClick={() => router.push(`/recruiter/dashboard/applicants/${applicant.id}?jobId=${jobId}`)}
                        className="block px-4 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition-colors font-semibold"
                      >
                        View Details
                      </button>
                    </div>
