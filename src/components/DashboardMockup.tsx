  ...
  return (
    <div className="max-w-4xl mx-auto pointer-events-none select-none">
      <div className="bg-card rounded-3xl shadow-card overflow-hidden border border-border/50">
        <div className="flex">
          {/* Sidebar */}
          <div className="w-56 bg-gradient-to-b from-flow-pink/30 to-card border-r border-border/50 p-4 hidden md:block">
            {/* Logo */}
          ...
          <div className="flex-1 p-6">
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-flow-purple to-flow-blue flex items-center justify-center">
            ...
            <div className="flex flex-col items-center mb-8">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-flow-yellow via-flow-purple to-flow-blue animate-float shadow-glow mb-4" />
            ...
            <div className="bg-muted/30 rounded-2xl p-4 border border-border/50">
              <div className="text-center">
                ...
                <div className="flex flex-wrap justify-center gap-2">
                  <span className="px-3 py-1.5 rounded-full bg-flow-purple/10 text-xs font-medium text-flow-purple">
                    Candidate
                  </span>
