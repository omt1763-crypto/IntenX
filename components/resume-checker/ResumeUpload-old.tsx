        ...
        >
          ...
          {!isVerified && (
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              className="p-4 bg-flow-blue/10 border border-flow-blue/30 rounded-lg flex gap-3"
            >
              <PhoneIcon className="w-5 h-5 text-flow-blue flex-shrink-0 mt-0.5" />
              <div className="flex-1">
                <p className="text-sm font-medium text-foreground mb-2">
                  Verify your phone number before scanning
                </p>
                <button
                  onClick={onUploadClick}
                  className="text-sm bg-flow-blue text-white px-4 py-2 rounded hover:bg-flow-blue/90 transition"
                >
                  Verify Phone Number
                </button>
              </div>
