...
import { FileUp, Upload, AlertCircle, CheckCircle, Lock, PhoneIcon } from 'lucide-react'
        ...
        <div className="text-center">
          {selectedFile ? (
            ...
            <>
              ...
              <p className="text-muted-foreground mb-6">PDF & DOCX only. Max 2MB file size.</p>
              <button
        ...
        >
          ...
          {!isVerified && (
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              className="p-4 bg-flow-blue/10 border border-flow-blue/30 rounded-lg"
            >
              <div className="flex gap-3">
                <PhoneIcon className="w-5 h-5 text-flow-blue flex-shrink-0 mt-0.5" />
                <div className="flex-1">
                  <p className="text-sm font-medium text-foreground mb-3">
                    Verify your phone number to unlock analysis
                  </p>
                  <button
                    onClick={onUploadClick}
                    className="text-sm bg-flow-blue hover:bg-flow-blue/90 text-white px-4 py-2 rounded transition"
                  >
                    Enter Phone Number
                  </button>
                </div>
